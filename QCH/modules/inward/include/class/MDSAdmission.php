	...
	public function loadAdmission() {
		...
		$out  = "<div class='".$this->css_Cont_class."' ><div class='opdHead' id='iadh'>".getPrompt("Initial admission details")."</div>\n";
			...
			$out .= "<table border=0 width=100% cellspacing=0   class='opdTbl'>\n";
					$out .= "<tr>\n"; 
					$out .= "<td>".getPrompt("BHT")." : </td><td>".$this->getValue("BHT")."</td><td align=center>Date &amp; Time of Admission : ".$this->getValue("AdmissionDate")."</td><td>".getPrompt("Ward")." : <a target='_self' href='home.php?page=wardpatient&action=View&WID=".$this->getValue("Ward")."'>".$this->getWard()."</a></td><td>Doctor : ".$doctor->getFullName()."</td><td align='right'>".$tools."</td>\n";
					$out .= "</tr>\n";					
					$out .= "<tr>\n"; 
					$out .= "<td valign=top>".getPrompt("Complaints").": </td><td colspan=3>".$this->getValue("Complaint")."</td>\n";
					$out .= "</tr>\n";			
					$out .= "<tr>\n"; 
					$out .= "<td colspan=2>".getPrompt("Remarks").": </td><td>".$this->getValue("Remarks")."</td><td colspan=2 align=right>";
