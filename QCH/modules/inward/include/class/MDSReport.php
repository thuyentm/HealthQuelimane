...
//            $out .=" Lines per page <input type='number' min=10 max=50 step=5 normal=30 class='input report_input' id='lines' name='lines' value='" . $this->lines . "'>  \n";
            ...
            $out .="<input type='submit' value='Make report' class='formButton'>\n";
            $out .="<a href='javascript:window.history.back()'>Back</a> ";
            $out .="</div> </form>\n";
...
//            $out .="<input type='submit' value='Make report' class='formButton'>\n";
            $out .="<a href='javascript:window.history.back()'>Back</a> ";
            $out .="</div> </form>\n";
        }else if ($this->rtype == "immr") {
            $out .=" <form method='GET' action='home.php'><div class='report_filter_cont'> \n";
            $out .=" Year <input type='number' min=2011 max=".date("Y")." step=1  class='input report_input' id='year' name='year' value='2011'>  \n";
            $out .=" Quarter <input type='number' min=1 max=4 step=1  class='input report_input' id='quarter' name='quarter' value='".$_GET['quarter']."'>  \n";
            $out .="<input type='hidden' id='page' name='page' value='" . $_GET['page'] . "'>\n";
            $out .="<input type='hidden' id='page' name='report' value='" . $_GET['report'] . "'> \n";
            $out .="<input type='submit' value='Make report' class='formButton'>\n";
            $out .="<a href='javascript:window.history.back()'>Back</a> ";
