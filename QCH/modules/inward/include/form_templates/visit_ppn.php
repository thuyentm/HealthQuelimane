...
$dat_d = date('d/m/Y');
$pat_hos_d = 'Rideegama Base Hospital, Rideegama District';
$pat_nam_d = 'M. M. Hussein'; 
$pat_pid_d = 'KBH17892';
$pat_age_d = '22yrs 4 mths';
//$pat_civ_d = 'Single';
$pat_add_d = "23 Habarana Road, Rideegama Town and Gravets, Rideegama, Sri Lanka";
...
//$vis_rem_d = 'Allergic to penicillin. Previously treated at the Galle hospital for dysmenorrhoea and inter-menstrual spotting. Given conjugated estrogens for 6 months.';
...
function Table($header,$data) {
    ...
    foreach($data as $row)
    {
        ...
        $row23 = $row[2] . '  ';
        $row23 = $row23 . $row[3];
        $this->MultiCell($w[2],4,$row23,0,'L',0);
        //$this->Ln();
    }
    //Closure line
...
$pdf->MultiCell(0,5, $pat_add_d,0,1,0);
//$pdf->SetXY($x2, 35);
...
$pdf->SetXY($x2+5, 59);
$pdf->MultiCell(0,5, $vis_dru_d,0,1,0);
//$pdf->SetXY($x2, 65);
