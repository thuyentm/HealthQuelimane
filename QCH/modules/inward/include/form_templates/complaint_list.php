...
$dat1_d = '01/01/2011';
$dat2_d = '31/01/2011';
$file_name_d = 'complaint_list.txt';  //(2 columns, "|" as delimiter)

// Document constants
$dat = date('d/m/Y');
$form_title = 'OPD Complaint List ' . ' From: ' . $dat1_d . ' To: ' . $dat2_d;
...
//Column titles
$header=array('Complaints treated','Number');
...
$pdf->Output('complaint_list.pdf','D'); 
?>
