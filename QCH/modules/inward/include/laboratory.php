...
//        $pager2->setDivStyle('position:absolute');
    ...
    $pager2->setColNames(array("LabID", "Test","Patient-ID", "Name", "Date", "By", "Sample Collection", "Status", "Priority",""));
    $pager2->setColOption("LAB_ORDER_ID", array("search" => true));
    ...
    $pager2->setColOption("Status", array("stype" => "select", "searchoptions" => array("value" => ":All;Pending:Pending;Done:Done;Rejected:Rejected", "Default" => "Pending")));
