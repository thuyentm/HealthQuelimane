...
$html = <<< HTML
<span style="color:#026890;font-size:1em;font-weight:bold;">
<h3>Period:</h3>
<label for="from">From</label>
<input type="text" id="from_k" name="from" value="" disabled="true" style="background:white;border:1px solid #3F719C;height:22px;"/>
<label for="to">to</label>
<input type="text" id="to_k" name="to" value="" disabled="true" style="background:white;border:1px solid #3F719C;height:22px;"/>
<br/>
</span>
<!--        <h3>Fields:</h3>
