...
//$res = $pid . "_" . $date;
//$patient_examForm["FLD"][0]["ExamDate"];
...
$patient_examForm["FLD"][9]=array(
	...
	$patient_examForm["FLD"][10]=array(
     ...
     $patient_examForm["FLD"][11]=array(
                                    "Id"=>"PID",     "Name"=>"pid",    "Type"=>"hidden",     "Value"=>$pid,
                                    "Help"=>"", "Ops"=>""
                                    );
	
	$patient_examForm["FLD"][12]=array(
                                    "Id"=>"LastUpDate",     "Name"=>"lastupdate",    "Type"=>"hidden",     "Value"=>$date,
                                    "Help"=>"", "Ops"=>""
                                    );
								
	$patient_examForm["FLD"][13]=array(
                                    "Id"=>"LastUpDateUser",     "Name"=>"lastupdateuser",    "Type"=>"hidden",     "Value"=>$_SESSION["FirstName"]." ".$_SESSION["OtherName"],
                                    "Help"=>"", "Ops"=>""
                                    );							
  
$patient_examForm["BTN"][0]=array(
                                   "Id"=>"SaveBtn",    "Name"=>"Save",   "Type"=>"button", "Value"=>"Save",     
                                    "Help"=>"",   "Ops"=>"",  "onclick"=>"saveData();canvas_save(" . $pid ."," . json_encode($date) .");",
                                    "Next"=>""
                                    );                                            
