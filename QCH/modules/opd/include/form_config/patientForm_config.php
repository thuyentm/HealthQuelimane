...
$patientForm["LIST"] = array( 'PID','LPID','ClinicNo', 'Full_Name_Registered', 'Personal_Used_Name', 'DateOfBirth', 'Gender','Personal_Civil_Status','NIC','Address_Village');
...
$patientForm["FLD"][4]=array(
 ...
 $patientForm["FLD"][7]=array(
                                    "Id"=>"NIC",   "Name"=>"NIC",    "Type"=>"nic",  "Value"=>"",
                                    "Help"=>"patient's National ID Card number ",    "Ops"=>"", "valid"=>"nic"
                                    ); 
