...
$allowedForms =  array("findingForm","disorderForm","eventForm","procedureForm","proceduresForm","ICDForm");
 $ok=0;
...
if ($ok == 0){
	...
	$rResult = mysql_query( $sQuery, $gaSql['link'] ) or die("");

	$sQuery = "
		SELECT FOUND_ROWS()
	";
	$rResultFilterTotal = mysql_query( $sQuery, $gaSql['link'] ) or die("error");
	...
	$sQuery = "
		...
		FROM   $sTable
	";
	$rResultTotal = mysql_query( $sQuery, $gaSql['link'] ) or die("error");
