   ...
   $menu .="<div id='left-sidebar'>\n";
		$menu .="<div class='basic' style='float:left;'  id='list1a'> \n";
			...
			$menu .="<div> \n";
							 ...
							 $menu .="<input type='button' class='submenuBtn' value='Specimen Clotted' onclick=self.document.location='home.php?page=specimenclotted' >\n";
			$menu .="</div> \n";
	$menu .=" </div> \n";
	$menu .="</div> \n";
...
function loadLaboratoryTable(){
   $tbl = "";
       ...
       $qry = " SELECT  
           ...
           WHERE ( lab_order.PID = patient.PID ) AND (lab_order.Dept = 'OPD') AND (lab_order.Status = 'Rejected') ";
