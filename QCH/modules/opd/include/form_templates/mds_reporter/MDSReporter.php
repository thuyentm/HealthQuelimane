...
class MDSReporter extends FPDF {
	...
	function __construct($orientation='P', $unit='mm', $format='A4', $footer=true) {
		...
		//$this->AddFont('akshara', '', 'akshara.php');
	}
	...
	function addCirtification($user, $text='Signature & Designation ', $fsize=8) {
		...
		$this->colRRow(array('', $_SESSION["FirstName"] . " " . $_SESSION["OtherName"]), false, 10, 4);
	}
