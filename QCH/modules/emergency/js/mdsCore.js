...
function updateSysReview(obj, cbox) {
    var review = "";
    $("input:checkbox[name=sreview]").each(function(i) {
        var tble = $(this).val();
...
function updateMedicalHistory(obj, cbox) {
    var review = "";
    $("input:checkbox[name=mhistory]").each(function(i) {
        var tble = $(this).val();
        var access = $(this).is(":checked");
...
function printReport(id, type) {
    ...
    } else if (type == 'PCUSlip') {
        url = "pcu_slip.php?PID=" + id;
