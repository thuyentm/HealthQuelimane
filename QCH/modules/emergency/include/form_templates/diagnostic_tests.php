...
if ( !$_GET["LID"] ) { echo "Invalid Order ";  exit(); }

require_once('mds_reporter/MDSReporter.php');
include_once '../class/MDSLabOrder.php';

$labOrder = new MDSLabOrder();
$labOrder->openId($_GET["LID"]);
$opd = $labOrder->getEpisode();
$pat = $opd->getAdmitPatient();
$lab_data = $labOrder->getLabDataJSON();
...
$pat_doctor_d = $opd->getEpisodeDoctor();
