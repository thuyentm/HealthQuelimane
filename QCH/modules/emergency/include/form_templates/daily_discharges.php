...
$mdsDB->connect();
$sql = "select a.PID as pid,p.Full_Name_Registered as patient,p.Personal_Used_Name as patient2,a.Complaint as complaint,u.FirstName as doctor,u.OtherName as doctor2,a.OutCome as outcome,w.`Name` as ward from admission as a,patient as p,`user` as u,ward as w where a.DischargeDate LIKE '$date%' and a.PID=p.PID and a.Doctor=u.UID and a.Ward=w.WID order by p.LPID";
