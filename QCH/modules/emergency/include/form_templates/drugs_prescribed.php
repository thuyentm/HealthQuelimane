...
// Document constants
$dat = date('d/m/Y');
$form_title = 'OPD Prescription List ' . ' From: ' . $dat1_d . ' To: ' . $dat2_d;
...
$file_name_d = 'drugs_prescribed_list_dev.txt';  //this file also to be passed (3 columns, "|" as delimiter)
$dat1_d = '01/01/2011';
$dat2_d = '31/01/2011';
...
class PDF extends FPDF {
    ...
    function Table($header,$data) {
        ...
        foreach($data as $row) {
            ...
            $average = number_format(round($row[2] / $row[1],1),1);
            $this->Cell($w[3],6,$average,0,'','R');
            }
        //Closure line
        $this->Ln();    
...
//Column titles
$header=array('Treatment prescribed','Num. pats.','Num. tabs.','Average num.');
//Data loading
...
$pdf->Output('drugs_prescribed_dev.pdf','D'); 
?>
