...
<div class="left">
	 ...
	 <a href="modules/opd/login.php"><img src="index_resources/images/outpatient.png" onmouseover="this.width=310;this.height=200;" onmouseout="this.width=210;this.height=150" alt="Out Patient Department" width="210" height="150" ></a>
	 &nbsp &nbsp &nbsp &nbsp &nbsp
	 <a href="modules/emergency/login.php"><img src="index_resources/images/pcuicon.png" onmouseover="this.width=310;this.height=200;" onmouseout="this.width=210;this.height=150" alt="Preliminary Care Unit" width="210" height="150" ></a>
	 &nbsp &nbsp &nbsp &nbsp &nbsp
	 <a href="modules/inward/login.php"><img src="index_resources/images/clinicicon.png" onmouseover="this.width=310;this.height=200;" onmouseout="this.width=210;this.height=150" alt="Clinic" width="210" height="150" ></a>
